...
Version  : 1.10.2
Release  : 49
URL      : https://gnupg.org/ftp/gcrypt/libgcrypt/libgcrypt-1.10.2.tar.gz
Source0  : https://gnupg.org/ftp/gcrypt/libgcrypt/libgcrypt-1.10.2.tar.gz
Source1  : https://gnupg.org/ftp/gcrypt/libgcrypt/libgcrypt-1.10.2.tar.gz.sig
...
%prep
%setup -q -n libgcrypt-1.10.2
cd %{_builddir}/libgcrypt-1.10.2
%patch1 -p1
%patch2 -p1
pushd ..
cp -a libgcrypt-1.10.2 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1680819278
