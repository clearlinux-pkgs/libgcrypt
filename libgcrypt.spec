...
Version  : 1.11.1
Release  : 53
URL      : https://gnupg.org/ftp/gcrypt/libgcrypt/libgcrypt-1.11.1.tar.gz
Source0  : https://gnupg.org/ftp/gcrypt/libgcrypt/libgcrypt-1.11.1.tar.gz
Source1  : https://gnupg.org/ftp/gcrypt/libgcrypt/libgcrypt-1.11.1.tar.gz.sig
...
%setup -q -n libgcrypt-1.11.1
cd %{_builddir}/libgcrypt-1.11.1
%patch -P 1 -p1
pushd ..
cp -a libgcrypt-1.11.1 build32
popd
pushd ..
cp -a libgcrypt-1.11.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746715683
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libgcrypt.so.20.5.1
/usr/lib64/libgcrypt.so.20
/usr/lib64/libgcrypt.so.20.5.1

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libgcrypt.so.20
/usr/lib32/libgcrypt.so.20.5.1
