...
Source0  : ftp://ftp.gnupg.org/gcrypt/libgcrypt/libgcrypt-1.7.6.tar.bz2
Source99 : ftp://ftp.gnupg.org/gcrypt/libgcrypt/libgcrypt-1.7.6.tar.bz2.sig
...
%prep
%setup -q -n libgcrypt-1.7.6
pushd ..
cp -a libgcrypt-1.7.6 build32
popd

%build
export LANG=C
export SOURCE_DATE_EPOCH=1485203768
...
/usr/lib64/libgcrypt.so.20.1.6

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libgcrypt.so.20
/usr/lib32/libgcrypt.so.20.1.6
